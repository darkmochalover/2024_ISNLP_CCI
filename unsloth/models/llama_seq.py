...
from peft import PeftModelForSequenceClassification, PeftMixedModel
...
class FastLlamaModelSequenceClassification:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        kwargs.pop("load_adapter", None); # No need since we auto call it
    ...
    def get_peft_model(
        ...
        **kwargs,
        ...
        model = _get_peft_model(model, lora_config, mixed=load_mixed_peft, adapter_name="adapter_all")
    ...
    def patch_peft_model(
        ...
        # print("model: ", model)
        # input()
        if not isinstance(model, PeftModelForSequenceClassification) and not isinstance(model, PeftMixedModel):
            raise TypeError(
