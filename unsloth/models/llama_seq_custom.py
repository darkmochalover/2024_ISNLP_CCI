...
from transformers.models.auto.modeling_auto import MODEL_FOR_CAUSAL_LM_MAPPING, MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING
...
class FastCustomLlamaSequenceClassification:
    @staticmethod
    def pre_patch():
        ...
        FastCustomLlamaSequenceClassification    .forward = Sequence_fast_forward(LlamaModel_fast_forward_inference)
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if model_patcher is None: model_patcher = FastCustomLlamaSequenceClassification
        ...
        model_function = MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING[model_config.__class__]
        ...
        model = FastCustomLlamaSequenceClassification.from_pretrained(
            model_name,
    ...
    #     model._saved_temp_tokenizer = _saved_temp_tokenizer
        ...
        model = FastCustomLlamaSequenceClassification.patch_peft_model(model, use_gradient_checkpointing)
        ...
        if train_score:
            ...
            model.model.score.modules_to_save.default.to(torch.float32)
            model.model.score.modules_to_save.default.requires_grad_(True)
        pass
