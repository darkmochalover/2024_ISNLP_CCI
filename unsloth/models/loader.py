...
from .llama_seq import FastLlamaModelSequenceClassification
from .llama_seq_custom import FastCustomLlamaSequenceClassification
from .mistral import FastMistralModel
from .mistral_seq import FastMistralModelSequenceClassification
...
class FastLanguageModel(FastLlamaModel):
    ...
    def from_pretrained(
        ...
        *args, **kwargs,
        ...
        if model_type == "llama":
            if sequence_classification and load_custom_model==False:
                dispatch_model = FastLlamaModelSequenceClassification
            elif sequence_classification and load_custom_model==True:
                dispatch_model = FastCustomLlamaSequenceClassification
            else:
                scaling_type = None
            ...
            if sequence_classification:
                dispatch_model = FastMistralModelSequenceClassification
            else:
        ...
        if resize_model_vocab is not None:
            tokenizer.add_special_tokens(resize_model_vocab)
        ...
        if is_peft:
            ...
            if saved_adapter_ids is not None:
                for name, id in saved_adapter_ids:
                    model.load_adapter(id, name)
...
class FastSequenceClassificationModel(FastLlamaModelSequenceClassification):
    @staticmethod
    def from_pretrained(
        model_name                 = "unsloth/llama-3-8b-bnb-4bit",
        max_seq_length             = None,
